        ...
        body: Container(
          ...
          child: ListView(children: [
            ...
            Padding(
              ...
              child: Text(
                "O Núcleo de Cuidado ao Estudante Universitário do Semiárido (NuCEU) foi instituído em 2019 na UNIVASF e tem sede no Centro de Estudos e  Práticas em Psicologia (CEPPSI). É um projeto de extensão vinculado à PROEX/UNIVASF que oferta ações presenciais e remotas inter e multidisciplinares de cuidado à saúde mental de universitários,  seus familiares, docentes e demais colaboradores de Instituições de Ensino Superior (IES), viabilizando, concomitantemente, desenvolvimento de competências em estudantes de Psicologia para atuação futura em contextos acadêmicos. Sensível ao fato de que as realidades do contexto das IES impõem a necessidade de uma equipe multidisciplinar de atenção psicossocial à saúde, o núcleo é composto por estudantes e profissionais de diversas áreas que visam prevenir e intervir com vistas à saúde e à qualidade de vida daqueles quem compõem a comunidade acadêmica. É um projeto de extensão vinculado à PROEX UNIVASF que já beneficiou muitas pessoas, através de atividades presenciais como atendimentos emergenciais, atendimentos individuais, grupos interventivos, integração de calouros, oficinas, palestras, plantão psicológico no CEPPSI e plantão psicológico itinerante, além de reuniões com gestores e professores, e rodas de conversa. Assim, esse aplicativo visa ajudar você com ações que visam beneficiar seu percurso acadêmico. Vem com a gente!",
                style: Themes.latoLight(16),
