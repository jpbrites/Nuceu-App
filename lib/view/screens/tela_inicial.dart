      ...
      body: Center(
        child: Column(children: [
          Padding(
            ...
            child: Image.asset('imagens/logo_nuceu.png',
                width: 173.0, height: 61.0, alignment: Alignment.bottomLeft),
          ),
          Text(
          ...
          Padding(
            padding: EdgeInsets.only(
                ...
                bottom: 0),
            child: Image.asset('imagens/univasf.png',
                width: 72.0, height: 19.0, alignment: Alignment.bottomLeft),
          ),
        ]),
      ),
    );
