...
class _InterestSignalState extends State<InterestSignal> {
      ...
      onPressed: () {
        showDialog(
          ...
          builder: (context) => AlertDialog(
                ...
                children: <Widget>[
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(
                        border: OutlineInputBorder(), hintText: 'Seu Email'),
            ...
            actions: [
              TextButton(onPressed: submit, child: const Text('Submeter')),
            ],
          ),
        );
      },
  ...
  void submit() {
    ...
    emailValid == true
        ? sendFirebase()
        : failEmail('Email inválido, por favor tentar novamente');
  }
  ...
  Future<void> sendFirebase() async {
    try {
      await FirebaseFirestore.instance
          ...
          .doc(widget.id)
          .update({
        "emailsCadastrados": FieldValue.arrayUnion([controller.text])
      });
      sucessEmail();
    } catch (e) {
      print(e);
